...
class Set5DG(srdata.SRData):
    def __init__(self, args, name='Set5DG', train=True, benchmark=False):
        ...
        super(Set5DG, self).__init__(
            args, name=name, train=train, benchmark=benchmark
        )

    def _scan(self):
        names_hr, names_lr = super(Set5DG, self)._scan()
